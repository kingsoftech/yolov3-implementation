# -*- coding: utf-8 -*-
"""
Created on Wed Apr 22 02:03:16 2020
...
if __name__ ==  '__main__':
    ...
    for batch in im_batches:
        ...
        for im_num, image in enumerate(imlist[i*batch_size: min((i +  1)*batch_size, len(imlist))]):
            ...
            for j in objs:
                ...
                if j=="car":
                    no_of_cars +=1
            print("no of cars are:", no_of_cars)
            print("no of persons are:", no_of_person)
            print("----------------------------------------------------------")
        i += 1
    ...
    #viewing the individual images
    #list(map(cv2.imshow, det_names, orig_ims))
    cv2.waitKey(1)
